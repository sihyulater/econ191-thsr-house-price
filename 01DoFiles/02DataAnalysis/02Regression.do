...
est clear
eststo: reg ln_price inter11 min_dist post1 if regspec1 == 1, r
	estadd local  contractual  "No"
	estadd local  structural  "No"
eststo: reg ln_price inter11 min_dist post1 $contr if regspec1 == 1, r
	estadd local  contractual  "Yes"
	estadd local  structural  "No"
eststo: reg ln_price inter11 min_dist post1 $struc if regspec1 == 1, r
	estadd local  contractual  "No"
	estadd local  structural  "Yes"
eststo: reg ln_price inter11 min_dist post1 $struc $contr if regspec1 == 1, r
	estadd local  contractual  "Yes"
	estadd local  structural  "Yes"
